...
int Led_2 = 4; //ตัวแปรLed_2 กำหนดให้มีค่าคือ4 เพื่อเตรียมกำหนดการทำงานที่Pin(ขา)4 ในชุดคำสั่งต่อไป
int Led_3 = 6; //ตัวแปรLed_3 กำหนดให้มีค่าคือ6 เพื่อเตรียมกำหนดการทำงานที่Pin(ขา)6 ในชุดคำสั่งต่อไป
int Led_4 = 8; //ตัวแปรLed_4 กำหนดให้มีค่าคือ6 เพื่อเตรียมกำหนดการทำงานที่Pin(ขา)8 ในชุดคำสั่งต่อไป
